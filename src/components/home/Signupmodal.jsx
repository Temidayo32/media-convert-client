...
const Signupmodal = () => {
  ...
  return (
    <div className="bg-teal-500 border mx-4 sm:mx-8 md:mx-16 lg:mx-24 xl:mx-48 my-8 p-8 sm:p-12 md:p-16 border-teal-600 rounded-lg shadow-2xl transition-transform duration-300 hover:scale-105 text-center">
