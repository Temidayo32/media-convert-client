  ...
  return (
    <div className='grid grid-cols-4 gap-2'>
      {conversions.map((conversion, index) => (
        <div key={index} className="text-gray-700 hover:text-teal-500 transition-transform duration-300 ease-in-out transition-colors hover:bg-gray-100 p-1 py-6 text-base">
