...
const Dashboard = () => {
  ...
  return (
    <div className="flex">
        {isSidebarOpen ? (
          <aside className={`relative mt-20 z-40 sm:z-auto top-0 left-0 sm:top-auto sm:left-auto transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full sm:-translate-x-0'} transition-transform duration-300 ${isSidebarOpen ? 'w-1/3': 'hidden'} sm:w-1/5 bg-white shadow-lg text-gray-700`}>
          ...
          <aside className="w-16 mt-10 sm:w-20 bg-white shadow-lg text-gray-700">
